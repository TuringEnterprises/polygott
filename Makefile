...
turing: ## Build Docker image with all languages
	docker build --progress=plain  -t $(IMAGE_TAG) --build-arg LANGS="nodejs,typescript,csharp,java,python3,php,kotlin,go,cpp,ruby,swift,haskell,python3_blank,nodejs_blank,typescript_blank,perl" .
